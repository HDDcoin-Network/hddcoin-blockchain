...
import { CardHero, Flex, Link } from '@rolls/core';
import { PlotHero as PlotHeroIcon } from '@rolls/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn PecanRolls. '
              }
              <Link
                target="_blank"
                href="https://github.com/Strandedathome/rolls-blockchain/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>
