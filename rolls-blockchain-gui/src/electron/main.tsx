...
if (!handleSquirrelEvent()) {
  ...
  if (ensureSingleInstance() && ensureCorrectEnvironment()) {
    ...
    const appReady = async () => {
      ...
      // if the daemon isn't local we aren't going to try to start/stop it
      if (rollsConfig.manageDaemonLifetime()) {
        rollsEnvironment.startRollsDaemon();
      }
    };
  ...
  const getMenuTemplate = () => {
      ...
      },
      {
        ...
        submenu: [
          ...
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/Rolls-Network/rolls-blockchain/issues',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal('https://keybase.io/team/rolls_network.public');
            },
          },
          {
            label: i18n._(/* i18n */ { id: 'Follow on Twitter' }),
            click: () => {
              openExternal('https://twitter.com/rolls_project');
            },
          },
        ],
      },
    ...
    if (process.platform === 'darwin') {
      // Rolls Blockchain menu (Mac)
      template.unshift({
        label: i18n._(/* i18n */ { id: 'Rolls' }),
        submenu: [
          {
            label: i18n._(/* i18n */ { id: 'About Rolls Blockchain' }),
            click: () => {
              openAbout();
            },
          },
